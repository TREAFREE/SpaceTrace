...
ADR-003 remains **Proposed**. Genuine daemon drop/wrap conditions, property-based state sequences, user-selected bookmark composition, and oldest-supported-OS qualification are still open validation items.
