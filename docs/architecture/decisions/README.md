...
| [ADR-004](ADR-004-sqlite-persistence-and-retention.md) | SQLite adapter and 30-day bounded retention | Proposed; raw adapter retained; recovery, schema-v9 directory/volume history, reconciliation, and current-host benchmark implemented; oldest-OS gate pending |
