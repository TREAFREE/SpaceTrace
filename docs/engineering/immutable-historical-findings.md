...
3. implement explicit user-controlled export with preview, cancellation, interruption recovery, path/token redaction tests, and no automatic upload, satisfying FR-014;
4. complete signed-sandbox restart/revocation/external-volume, clean quarantine, macOS 15.6, distribution-trust, and maintainer-acceptance gates.
