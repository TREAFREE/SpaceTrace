...
- `swift test --package-path Packages/SpaceTraceKit`: 135 tests in 20 suites (the destructive-environment qualification remains opt-in and is reported as skipped here);
